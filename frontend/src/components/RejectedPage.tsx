            ...
            <div className="text-center space-y-6">
              <div className="flex justify-center">
                <div className="w-20 h-20 rounded-full flex items-center justify-center" style={{
                  ...
                  <XCircle className="w-10 h-10" style={{ color: 'rgba(185, 28, 28, 0.9)' }} />
                </div>
              </div>
              <div>
                ...
                <p className="mt-3 text-sm" style={{ color: 'rgba(71, 85, 105, 0.7)' }}>
                  Olá, <strong>{user?.name}</strong>! Sua solicitação de acesso foi rejeitada.
                </p>
                {user?.rejectionReason && (
                  <div className="mt-3 p-3 rounded-lg text-left" style={{
                    background: 'rgba(239, 68, 68, 0.1)',
                    border: '1px solid rgba(239, 68, 68, 0.2)',
                  }}>
                    <p className="text-xs font-medium" style={{ color: 'rgba(185, 28, 28, 0.9)' }}>Motivo:</p>
                    <p className="text-sm mt-1" style={{ color: 'rgba(71, 85, 105, 0.8)' }}>
                      {user.rejectionReason}
                    </p>
                  </div>
                )}
                <p className="mt-3 text-sm" style={{ color: 'rgba(71, 85, 105, 0.6)' }}>
